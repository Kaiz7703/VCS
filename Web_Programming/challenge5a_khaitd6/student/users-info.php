...
<html lang="en">
  <head>
    ...
    <title>Student  Management System|| Users Info</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Thong tin nguoi dung </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item active" aria-current="page"> Thong tin nguoi dung </li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;"> Thong tin nguoi dung </h4>
...
{           ?>
                      ...
                      ?>
                      <div class="form-group">
                        <label for="exampleInputName1">De lai loi nhan</label>
